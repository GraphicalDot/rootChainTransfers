...
import { ExitTokensCall } from '../../generated/ERC1155Predicate/ERC1155Predicate'


export function handleNewERC1155PredicateTransfer(call: ExitTokensCall): void {
    let id = call.transaction.hash.toHex()
    let transaction = new Withdrawal(id)
    transaction.log = call.inputs.log
    transaction.rootToken = call.inputs.rootToken
    transaction.predicateType= "erc1155"
